 ...
 */
final class Version20200616132632 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article ADD CONSTRAINT FK_23A0E661E969C5 FOREIGN KEY (utilisateurs_id) REFERENCES users (id)');
